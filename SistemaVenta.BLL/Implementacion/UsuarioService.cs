...
namespace SistemaVenta.BLL.Implementacion
{
    public class UsuarioService : IUsuarioService
    {
        ...
        public async Task<Usuario> Crear(Usuario entidad, Stream Foto = null, string NombreFoto = "", string UrlPlantillaCorreo = "")
        {
            ...
            try
            {
                // Generamos una clave para el usuario y la guardamos encriptada en la entidad.
                ...
                // Verifica si se creo exitosamente el usuario, sino lanza un error y frena la ejecucion.
                if (usuario_creado.IdUsuario == 0)
                    throw new TaskCanceledException("No se pudo crear el usuario.");

                // Logica para enviar el correo una vez creado el usuario.

...
public partial class DbventaContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.IdCategoria).HasName("PK__Categori__8A3D240C9F6EE07A");
        ...
        {
            entity.HasKey(e => e.IdDetalleVenta).HasName("PK__DetalleV__BFE2843F8063ABD6");
        ...
        {
            entity.HasKey(e => e.IdMenu).HasName("PK__Menu__C26AF483D4F52DFC");
        ...
        {
            entity.HasKey(e => e.IdNegocio).HasName("PK__Negocio__70E1E1078FE16349");
        ...
        {
            entity.HasKey(e => e.IdNumeroCorrelativo).HasName("PK__NumeroCo__25FB547EF79BC210");
        ...
        {
            entity.HasKey(e => e.IdProducto).HasName("PK__Producto__07F4A13223DFC5A9");
        ...
        {
            entity.HasKey(e => e.IdRol).HasName("PK__Rol__3C872F76B2680CFB");
        ...
        {
            entity.HasKey(e => e.IdRolMenu).HasName("PK__RolMenu__CD2045D89E95BEBF");
        ...
        {
            entity.HasKey(e => e.IdTipoDocumentoVenta).HasName("PK__TipoDocu__A9D59AEEE4C2C6D6");
        ...
        {
            entity.HasKey(e => e.IdUsuario).HasName("PK__Usuario__645723A621DB1571");
        ...
        {
            entity.HasKey(e => e.IdVenta).HasName("PK__Venta__077D5614DBDEA884");
